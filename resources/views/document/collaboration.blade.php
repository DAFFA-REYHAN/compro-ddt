...
@section('content')
    <section class="container py-5 py-md-6">
        <div class="mb-4 text-center">
            ...
            <h2 class="fw-bold mb-2">Kerja Sama</h2>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="tab-content p-3 p-md-4" id="doc-vertical-tabs-content">
                        ...
                        {{-- Dokumen 1 --}}
                        <div class="tab-pane fade text-center show active" id="doc-1" role="tabpanel">
                        ...
                        {{-- Dokumen 2 --}}
                        <div class="tab-pane fade text-center" id="doc-2" role="tabpanel">
                        ...
                        {{-- Dokumen 3 --}}
                        <div class="tab-pane fade text-center" id="doc-3" role="tabpanel">
                        ...
                        {{-- Dokumen 4 --}}
                        <div class="tab-pane fade text-center" id="doc-4" role="tabpanel">
                        ...
                        {{-- Dokumen 5 --}}
                        <div class="tab-pane fade text-center" id="doc-5" role="tabpanel">
