     ...
     <div class="container">
         ...
         <div class="row g-4">
             <div class="col-lg-5" data-aos="fade-right">
                 <div class="location-card border">

                     <h4 class="mb-4"> <i class="iconbase ti tabler-map-pin me-2"></i>
                         {{ __('home.contacth4') }}
                     </h4>
                     ...
                     <div class="location-info">
                         <div class="info-item">
                             ...
                             <div>
                                 ...
                                 <p>Jl. Letjend Suprapto No.1, Kibing, Kec. Batu Aji, Kota Batam, Kepulauan Riau 29424
                                 </p>
                             </div>
                         </div>
                         ...
                         <div class="info-item">
                             ...
                             <div>
                                 <strong>{{ __('home.telephone') }}</strong>
                                 <p>(0778) 3582877, 7355372</p>
                             </div>
                         </div>
                         ...
                         <div class="info-item">
                             ...
                             <div>
                                 <strong>{{ __('home.operational') }}</strong>
                                 <p>{{ __('home.days1') }}: 08:00 - 17:00<br>{{ __('home.days2') }}: 08:00 - 14:00</p>
                             </div>
                         </div>
                     </div>
